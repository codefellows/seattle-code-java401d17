...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    //TODO: Step 2-2: (In main activity) create come data items (instances of the class!)
    List<Product> products = new ArrayList<>();
    products.add(new Product("pencils"));
    products.add(new Product("pens"));
    products.add(new Product("rules"));
    products.add(new Product("notebooks"));
    products.add(new Product("calculators"));
    products.add(new Product("flask"));


    setUpSettingsButton();
    //TODO: Step 2-3: (in main activity and RecyclerViewAdapter) Hand in the date items
