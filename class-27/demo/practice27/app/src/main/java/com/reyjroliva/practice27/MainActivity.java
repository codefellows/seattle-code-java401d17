package com.reyjroliva.practice27;
...
import com.reyjroliva.practice27.activities.OrderFormActivity;
import com.reyjroliva.practice27.activities.UserProfileActivity;
...
public class MainActivity extends AppCompatActivity {
  ...
  public static final String PRODUCT_NAME_EXTRA_TAG = "productName"; // at the top of class, for sharing
  ...
  protected void onResume() {
    ...
    String userNickname = preferences.getString(UserProfileActivity.USER_NICKNAME_TAG, "No nickname"); // Note that we're grabbing the tag from UserProfileActivity, NOT declaring it in this activity!
  ...
  public void setUpOrderFormButton() {
    ...
    goToOrderFormButton.setOnClickListener(v -> { // <-- shorthand for new View.OnClickListner
      ...
      // To pass an Intent Extra, first grab the string value you want to pass
      String productName = ((EditText) findViewById(R.id.mainActivityOrderInputEditText)).getText().toString();
  ...
  public void setUpUserProfileButton() {
    findViewById(R.id.mainActivityUserProfileButtonImageView).setOnClickListener(v -> {
