...
public final class Product implements Model {
  ...
  public static final QueryField S3_KEY = field("Product", "s3Key");
  ...
  private Product(String id, String name, String description, Temporal.DateTime dateCreated, ProductCategoryEnum productCategory, Contact contactPerson, String s3Key) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), product.getId()) &&
              ...
              ObjectsCompat.equals(getS3Key(), product.getS3Key()) &&
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String description, Temporal.DateTime dateCreated, ProductCategoryEnum productCategory, Contact contactPerson, String s3Key) {
      super.id(id);
      super.name(name)
